    ...
    <div className='bg-custom-gray min-h-screen p-3'>
        ...
        <div className='flex justify-center'>
          <div className='mr-7 mt-7 flex flex-col'>
            ...
            <button className='bg-black rounded-xl w-[80px] h-[84px] flex flex-col items-center mb-3'>
              <span className='text-gray-300 mb-1'>
                <span className='text-5xl'>+</span><br/>
                <span className='text-gray-500 font-semibold'>Receive</span>
              </span>
            </button>

            <button className='bg-black rounded-xl w-[80px] h-[84px] flex flex-col items-center mb-3'>
              <span className='text-gray-300 mb-1 mt-2'>
                <span className='material-icons text-4xl'>send</span><br/>
                <span className='text-gray-500 font-semibold'>Send</span>
              </span>
            </button>
            ...
            <button className='bg-black rounded-xl w-[80px] h-[84px] flex flex-col items-center mb-3'>
              <span className='text-gray-300 mb-1 mt-2'>
                ...
                <span className='text-gray-500 font-semibold'>Swap</span>
              </span>
            </button>

            <button className='bg-black rounded-xl w-[80px] h-[84px] flex flex-col items-center'>
              <span className='text-gray-300 mb-1 mt-2'>
                <span className='material-icons text-4xl'>attach_money</span><br/>
                <span className='text-gray-500 font-semibold'>Buy</span>
              </span>
            </button>
        ...
        <div className='w-96 flex flex-col justify-center items-center text-6xl h-28 mt-5 mb-1 font-semibold'>$5.00</div>
          ...
          <div className='w-[800px] h-64'>
            <div className='h-16 my-5 bg-custom-gray rounded-2xl flex flex-row justify-between items-center'>
